...
export function StageList() {
  ...
  return html`
    <div style="display:flex;flex-direction:column;flex-wrap:nowrap;gap:2px;align-items:stretch">
      ${STAGES.map((d, i) => {
        ...
        return html`
          <div style="display:flex;align-items:flex-start;flex-direction:column">
            ${i > 0 ? html`<div style="width:2px;height:14px;background:#e2d9c7;margin-left:15px"></div>` : ''}
            <div style="display:flex;align-items:center;gap:10px;padding:5px 6px">
