...
const ORDER = [
  'src/lexicon.js',
  // Prompt fragments (must be inlined before prompts/index.js and constants.js)
  'src/prompts/composer-persona.js',
  'src/prompts/dialect-requirement.js',
  'src/prompts/lyrics-format.js',
  'src/prompts/style-format.js',
  'src/prompts/title-rule.js',
  'src/prompts/output-contract.js',
  'src/prompts/critic-persona.js',
  'src/prompts/critic-output.js',
  'src/prompts/song-formula.js',
  'src/prompts/common-openers.js',
  'src/prompts/emotional-vividness.js',
  'src/prompts/cultural-authenticity.js',
  'src/prompts/chorus-techniques.js',
  'src/prompts/narrative-themes.js',
  'src/prompts/dialect-examples.js',
  'src/prompts/iterative-improvement.js',
  'src/prompts/validation-rules.js',
  'src/prompts/critic-rules.js',
  'src/prompts/assemble-composer.js',
  'src/prompts/assemble-critic.js',
